...
b_sub=Button(root, text="-", padx=39, pady=20, command=button_add)
b_mul=Button(root, text="*", padx=39, pady=20, command=button_add)
b_div=Button(root, text="/", padx=39, pady=20, command=button_add)
